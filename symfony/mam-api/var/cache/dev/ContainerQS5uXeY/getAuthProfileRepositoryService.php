 ...
 */
class getAuthProfileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AuthProfileRepository' shared autowired service.
     *
     * @return \App\Repository\AuthProfileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AuthProfileRepository.php';

        return $container->privates['App\\Repository\\AuthProfileRepository'] = new \App\Repository\AuthProfileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
