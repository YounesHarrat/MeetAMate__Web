...
final class Version20210809144721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_social_network_data (user_id INT NOT NULL, social_network_data_id INT NOT NULL, INDEX IDX_20CEF659A76ED395 (user_id), INDEX IDX_20CEF6598C6B21D5 (social_network_data_id), PRIMARY KEY(user_id, social_network_data_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_social_network_data ADD CONSTRAINT FK_20CEF659A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_social_network_data ADD CONSTRAINT FK_20CEF6598C6B21D5 FOREIGN KEY (social_network_data_id) REFERENCES social_network_data (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_social_network_data DROP FOREIGN KEY FK_20CEF6598C6B21D5');
        ...
        $this->addSql('ALTER TABLE user_social_network_data DROP FOREIGN KEY FK_20CEF659A76ED395');
        $this->addSql('DROP TABLE auth_profile');
        $this->addSql('DROP TABLE game');
        $this->addSql('DROP TABLE social_network_data');
        $this->addSql('DROP TABLE user');
        $this->addSql('DROP TABLE user_game');
        $this->addSql('DROP TABLE user_user');
        $this->addSql('DROP TABLE user_social_network_data');
    }
}
